...
class BERTTEInference(nn.Module):
    ...
    def forward(self, token_seq, time_seq):
        ...
        outputs = self.transformer(token_seq, time_seq)
...
if __name__ == "__main__":
    ...
    model_tag = 'bert_te'
    model_path = os.path.join("bert-with-timeEmbedding", sys.argv[1])
    ...
    model = BERTTEInference(transformer=transformer, sequence_summary_type='max_pooling').to(device)
